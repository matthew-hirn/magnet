...
from utils.preprocess import geometric_dataset, load_edge_index, F_in_out
...
def main(args): 
    ...
    for i in range(10):
        ...
        model = Sym_Link(x.size(-1), 2, filter_num=args.num_filter, dropout=args.dropout).to(device)
        ...
        for epoch in range(args.epochs):
            ...
            model.train()
            out = model(x, edge_index, edge_in, in_weight, edge_out, out_weight,
